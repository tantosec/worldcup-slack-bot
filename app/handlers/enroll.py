...
def handle_enroll(respond, body):
    ...
    if not enrolled:
        respond(
            ":wave: You're already registered in the World Cup 2026 Prediction League!\n"
    ...
    if tournament_started:
        respond(
            f":tada: *Welcome to the {_ORG} World Cup 2026 Prediction League!*\n"
            "\n"
        ...
        respond(
            ...
            "  :white_check_mark: Correct result → *3 pts*\n"
            "  :zap: Upset bonus → *+2 pts*\n"
            "  :trophy: Winner / :athletic_shoe: Golden Boot → *30 pts each*\n"
            "  :four: Semi-finalists → *15 pts per correct team*\n"
            "  :goal_net: Group stage goals guess → *up to 25 pts*\n"
            "  :zebra_face: Zebra Pick → underdog bonus (up to *160 pts* for a Wildcard winner!)\n"
            "\n"
